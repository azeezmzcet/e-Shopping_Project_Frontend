  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center p-4 bg-white shadow-md">
        ...
        <img className="h-20 w-auto" src={logo} alt="store logo" />                                                                                            {/*storelogo*/}
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center cursor-pointer">
            ...
            <div onClick={() => dispatch(logout())}>
              ...
              </Tooltip> <p className="ml-2">logout</p>
      ...
      <div className="bg-black p-3 w-full flex items-center justify-center  ">
        <p className="text-white font-inter text-base font-medium"><marquee  behavior="scroll" direction="left" scrollamount="5" width="200%">50%OFF   </marquee></p>
        <p className="text-white font-inter text-base font-medium mx-96">
        <marquee  behavior="scroll" direction="left" scrollamount="5" width="200%"> Free Shipping and Returns</marquee>
        </p>
        <p className="text-white font-inter text-base font-medium">
        <marquee  behavior="scroll" direction="left" scrollamount="5" width="200%"> Different Payment Methods</marquee>
        </p>
      </div> 
    </>
  );
